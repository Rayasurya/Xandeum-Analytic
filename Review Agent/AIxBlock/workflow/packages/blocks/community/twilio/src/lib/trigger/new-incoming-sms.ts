...
export const twilioNewIncomingSms = createTrigger({
  ...
  sampleData: {
    ...
    price: null,
    error_message: null,
    uri: '/2010-04-01/Accounts/AC_SAMPLE_ACCOUNT_SID/Messages/SM_SAMPLE_MESSAGE_SID.json',
    account_sid: 'AC_SAMPLE_ACCOUNT_SID',
    num_media: '0',
    to: '+1234567890',
    date_created: 'Wed, 08 Feb 2023 01:40:50 +0000',
    status: 'failed',
    sid: 'SM_SAMPLE_MESSAGE_SID',
    date_sent: 'Wed, 08 Feb 2023 01:40:51 +0000',
    messaging_service_sid: 'MG_SAMPLE_SERVICE_SID',
    error_code: 21211,
    price_unit: 'USD',
    api_version: '2010-04-01',
    subresource_uris: {
      media:
        '/2010-04-01/Accounts/AC_SAMPLE_ACCOUNT_SID/Messages/SM_SAMPLE_MESSAGE_SID/Media.json',
      feedback:
        '/2010-04-01/Accounts/AC_SAMPLE_ACCOUNT_SID/Messages/SM_SAMPLE_MESSAGE_SID/Feedback.json',
    },
  },
